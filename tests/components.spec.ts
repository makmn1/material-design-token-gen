...
const COMPONENT_TEST_DATA: ComponentTestData[] = [
    ...
    },
    {
        ...
        key: "navigation-rail",
        sampleTokens: [
            { key: "md.comp.nav.rail.item.icon.size", expected: "1.7143rem" },
            { key: "md.comp.nav.rail.item.active.indicator.shape", expected: "md.sys.shape.corner.full" },
            { key: "md.comp.nav.rail.item.active.indicator.leading.space", expected: "1.1429rem" },
            { key: "md.comp.nav.rail.item.active.indicator.icon.label.space", expected: "0.5714rem" },
            { key: "md.comp.nav.rail.item.container.height", expected: "4.5714rem" },
            { key: "md.comp.nav.rail.item.short.container.height", expected: "4rem" },
            { key: "md.comp.nav.rail.item.container.vertical.space", expected: "0.4286rem" },
            { key: "md.comp.nav.rail.item.header.space.minimum", expected: "2.8571rem" },
            ...
            { key: "md.comp.nav.rail.collapsed.container.width", expected: "6.8571rem" },
            { key: "md.comp.nav.rail.collapsed.narrow.container.width", expected: "5.7143rem" },
            { key: "md.comp.nav.rail.collapsed.container.elevation", expected: "md.sys.elevation.level0" },
            { key: "md.comp.nav.rail.collapsed.item.vertical.space", expected: "0.2857rem" },
            { key: "md.comp.nav.rail.collapsed.item.top.space", expected: "3.1429rem" },
            { key: "md.comp.nav.rail.expanded.container.width.minimum", expected: "15.7143rem" },
            { key: "md.comp.nav.rail.expanded.container.width.maximum", expected: "25.7143rem" },
            { key: "md.comp.nav.rail.expanded.modal.container.shape", expected: "md.sys.shape.corner.large" },
            { key: "md.comp.nav.rail.item.vertical.active.indicator.height", expected: "2.2857rem" },
            { key: "md.comp.nav.rail.item.vertical.active.indicator.width", expected: "4rem" },
            { key: "md.comp.nav.rail.item.vertical.icon.label.space", expected: "0.2857rem" },
    ...
    },
    {
        ...
        sampleTokens: [
            ...
            { key: "md.comp.switch.track.height", expected: "2.2857rem" },
            { key: "md.comp.switch.track.width", expected: "3.7143rem" },
            { key: "md.comp.switch.track.outline.width", expected: "0.1429rem" },
            { key: "md.comp.switch.selected.track.color", expected: "md.sys.color.primary" },
            { key: "md.comp.switch.unselected.handle.height", expected: "1.1429rem" },
            { key: "md.comp.switch.pressed.handle.width", expected: "2rem" },
            { key: "md.comp.switch.state.layer.size", expected: "2.8571rem" },
