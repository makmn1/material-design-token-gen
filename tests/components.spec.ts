...
const COMPONENT_TEST_DATA: ComponentTestData[] = [
    ...
    },
    {
        ...
        sampleTokens: [
            ...
            { key: "sm.comp.progress-indicator.linear.width", expected: "100%" },
            { key: "sm.comp.progress-indicator.linear.width.minimum", expected: "2.5rem" },
            { key: "sm.comp.progress-indicator.linear.with-wave.width", expected: "100%" },
            { key: "sm.comp.progress-indicator.linear.with-wave.width.minimum", expected: "2.5rem" },
