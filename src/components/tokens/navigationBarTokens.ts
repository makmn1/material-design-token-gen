export const navigationBarCommonColorEnabled: Record<string, string | number> = {
    ...
    "md.comp.nav.bar.item.indicator.color": "md.sys.color.secondary-container",
...
export const navigationBarCommonNavItem: Record<string, string | number> = {
    "md.comp.nav.bar.space.between.items": 0,
    "md.comp.nav.bar.item.shape": "md.sys.shape.corner.full",
    "md.comp.nav.bar.item.space.between.icon.label.space": "4dp",
    "md.comp.nav.bar.item.icon.size": "24dp",
};

export const navigationBarCommonContainer: Record<string, string | number> = {
    "md.comp.nav.bar.height": "64dp",
    "md.comp.nav.bar.shape": "md.sys.shape.corner.none",
};
