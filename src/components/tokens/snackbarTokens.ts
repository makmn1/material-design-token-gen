export const snackbarEnabledContainer: Record<string, string | number> = {
    ...
    "md.comp.snackbar.container.single.line.height": "48dp",
    "md.comp.snackbar.container.two.lines.height": "68dp",
};

export const snackbarEnabledLabelText: Record<string, string | number> = {
    "md.comp.snackbar.label.text.color": "md.sys.color.inverse-primary",
    "md.comp.snackbar.label.text.font": "md.sys.typescale.label-large.font",
    "md.comp.snackbar.label.text.line.height": "md.sys.typescale.label-large.line-height",
    "md.comp.snackbar.label.text.size": "md.sys.typescale.label-large.size",
    "md.comp.snackbar.label.text.tracking": "md.sys.typescale.label-large.tracking",
    "md.comp.snackbar.label.text.weight": "md.sys.typescale.label-large.weight",
};
...
export const snackbarHoveredLabelText: Record<string, string | number> = {
    "md.comp.snackbar.hover.label.text.color": "md.sys.color.inverse-primary",
};

export const snackbarHoveredStateLayer: Record<string, string | number> = {
    "md.comp.snackbar.hover.state.layer.color": "md.sys.color.inverse-primary",
    "md.comp.snackbar.hover.state.layer.opacity": "md.sys.state.hover.state-layer-opacity",
...
export const snackbarFocusedLabelText: Record<string, string | number> = {
    "md.comp.snackbar.focus.label.text.color": "md.sys.color.inverse-primary",
};

export const snackbarFocusedStateLayer: Record<string, string | number> = {
    "md.comp.snackbar.focus.state.layer.color": "md.sys.color.inverse-primary",
    "md.comp.snackbar.focus.state.layer.opacity": "md.sys.state.focus.state-layer-opacity",
...
export const snackbarPressedLabelText: Record<string, string | number> = {
    "md.comp.snackbar.pressed.label.text.color": "md.sys.color.inverse-primary",
};

export const snackbarPressedStateLayer: Record<string, string | number> = {
    "md.comp.snackbar.pressed.state.layer.color": "md.sys.color.inverse-primary",
    "md.comp.snackbar.pressed.state.layer.opacity": "md.sys.state.pressed.state-layer-opacity",
