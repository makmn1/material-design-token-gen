...
export const progressIndicatorLinearBaseline: Record<string, string | number> = {
    ...
    "md.comp.progress-indicator.linear.wave.amplitude": "3dp",
    "md.comp.progress-indicator.linear.wave.wavelength": "40dp",
    "md.comp.progress-indicator.linear.indeterminate.wave.wavelength": "20dp",
};

export const progressIndicatorCircularBaseline: Record<string, string | number> = {
    "md.comp.progress-indicator.circular.size": "40dp",
    "md.comp.progress-indicator.circular.size.with.wave": "48dp",
