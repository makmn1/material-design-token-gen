export const carouselEnabledOutline: Record<string, string | number> = {
  "md.comp.carousel.item.outline.color": "md.sys.color.outline",
  "md.comp.carousel.item.outline.width": "1dp",
};
...
export const carouselHoverOutline: Record<string, string | number> = {
  "md.comp.carousel.item.hover.outline.color": "md.sys.color.outline",
};
...
export const carouselFocusFocusIndicator: Record<string, string | number> = {
  ...
  "md.comp.carousel.focus.indicator.offset": "md.sys.state.focus-indicator.outer-offset",
};

export const carouselFocusOutline: Record<string, string | number> = {
  "md.comp.carousel.item.focus.outline.color": "md.sys.color.on-surface",
};
...
export const carouselPressedOutline: Record<string, string | number> = {
  "md.comp.carousel.item.pressed.outline.color": "md.sys.color.outline",
};
...
export const carouselDisabledOutline: Record<string, string | number> = {
  "md.comp.carousel.item.disabled.outline.color": "md.sys.color.outline",
  "md.comp.carousel.item.disabled.outline.opacity": 0.12,
};
