export const fabSizeBaseline: Record<string, string | number> = {
  "md.comp.fab.container.height": "56dp",
  "md.comp.fab.container.width": "56dp",
  "md.comp.fab.icon.size": "24dp",
  "md.comp.fab.container.shape": "md.sys.shape.corner.large",
};

export const fabSizeMedium: Record<string, string | number> = {
  "md.comp.fab.medium.container.height": "80dp",
  "md.comp.fab.medium.container.width": "80dp",
  "md.comp.fab.medium.icon.size": "28dp",
  "md.comp.fab.medium.container.shape": "md.sys.shape.corner.large-increased",
};

export const fabSizeLarge: Record<string, string | number> = {
  "md.comp.fab.large.container.height": "96dp",
  "md.comp.fab.large.container.width": "96dp",
  "md.comp.fab.large.icon.size": "36dp",
  "md.comp.fab.large.container.shape": "md.sys.shape.corner.extra-large",
};
...
export const fabTokens: Record<string, string | number> = Object.assign(
  ...
  fabSizeMedium,
  fabSizeLarge,
  fabColorTonalPrimaryEnabled,
  fabColorTonalPrimaryHovered,
  fabColorTonalPrimaryFocused,
  fabColorTonalPrimaryPressed,
  fabColorTonalSecondaryEnabled,
  fabColorTonalSecondaryHovered,
  fabColorTonalSecondaryFocused,
  fabColorTonalSecondaryPressed,
  fabColorTonalTertiaryEnabled,
  fabColorTonalTertiaryHovered,
  fabColorTonalTertiaryFocused,
  fabColorTonalTertiaryPressed,
  fabColorPrimaryEnabled,
  fabColorPrimaryHovered,
  fabColorPrimaryFocused,
  fabColorPrimaryPressed,
  fabColorSecondaryEnabled,
  fabColorSecondaryHovered,
  fabColorSecondaryFocused,
  fabColorSecondaryPressed,
  fabColorTertiaryEnabled,
